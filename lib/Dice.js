...
export default class Dice {
    ...
    constructor(side) {
        if(R.is(Object, side)) {
            ...
            if(side.unwrap) {
                let i = 0;
                side.config.forEach(e => {
                    let flattenedBias = Math.round(e.bias);
                    e.bias = 1;
            ...
            this.biasMatrix = R.times(e => 1, side);
        }
    }
    ...
    //TODO maybe call constructor here?? regardless make it return a fixed object.
    set sides(val) {
