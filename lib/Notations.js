...
export default class Notations {
    ...
    notations = [...baseNotations];

    selected = this.baseNotations[0];

    constructor(notation) {
        this.selected = R.find(R.propEq('id', notation))(this.notations) || R.find(R.propEq('name', notation))(this.notations) || this.baseNotations[0];
    }
    ...
    set selected(val) {
        this.selected = R.find(R.propEq('id', val))(this.notations) || R.find(R.propEq('name', val))(this.notations) || this.baseNotations[0];
    }
